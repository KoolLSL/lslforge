...
public class SimProject {
    ...
    private static HashMap<String,String> ID_TO_DISPLAY = new HashMap<>();
    ...
    static class KeyTracker {
        ...
        private HashMap<Object,String> xref = new HashMap<>();
...
//            }
    ...
    public static class GridCoordinateNode extends Node {
        ...
        private static final HashMap<String,String> NAME_TO_DISPLAY = new HashMap<>();
...
//    }
    ...
    public static SimWorldDef toSimWorldDef(WorldNode node) {
        ...
        LinkedList<Prim> allPrims = new LinkedList<>();
