...
public class LSLTest {
	...
	private ArrayList<GlobBinding> initialBindings = new ArrayList<>();
	private ArrayList<GlobBinding> finalBindings = new ArrayList<>();
	...
	public static class ExpectedCall {
		...
		private List<MaybeValue> args = new ArrayList<>();
	...
	public static class CallExpectations {
	    ...
	    private ArrayList<ExpectedCall> calls = new ArrayList<>();
