...
lslEventDescriptors = [
    ...
    ("at_target", [(LLInteger,"tnum"),(LLVector,"targetPos"),(LLVector,"ourpos")], EventDeliveryScript, [],
     "raised when a scripted object comes within a distance of a target position"),
    ...
    ("final_damage",[(LLInteger,"num_detected")], EventDeliveryScript, [],
    ...
    ("game_control",[(LLKey,"id"),(LLInteger,"button_levels"),(LLList,"axes")], EventDeliveryScript, [],
    ...
    ("on_damage",[(LLKey,"id")], EventDeliveryPrim, [],
