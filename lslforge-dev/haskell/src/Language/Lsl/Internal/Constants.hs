...
allConstants = [
    Constant "KOOL_VERSION_TEST" (SVal "31may2025 10:00"),
    ...
    Constant "AGENT_FLOATING_VIA_SCRIPTED_ATTACHMENT" (IVal 0x8000),
    ...
    Constant "GAME_CONTROL_AXIS_LEFTX" (IVal 0x00000000),
    Constant "GAME_CONTROL_AXIS_LEFTY" (IVal 0x00000001),
    Constant "GAME_CONTROL_AXIS_RIGHTX" (IVal 0x00000002),
    Constant "GAME_CONTROL_AXIS_RIGHTY" (IVal 0x00000003),
    Constant "GAME_CONTROL_AXIS_TRIGGERLEFT" (IVal 0x00000004),
    Constant "GAME_CONTROL_AXIS_TRIGGERRIGHT" (IVal 0x00000005),
    ...
    Constant "OVERRIDE_GLTF_BASE_COLOR_FACTOR" (IVal 1),
    Constant "OVERRIDE_GLTF_BASE_ALPHA" (IVal 2),
    Constant "OVERRIDE_GLTF_BASE_ALPHA_MODE" (IVal 3),
    Constant "OVERRIDE_GLTF_BASE_ALPHA_MASK" (IVal 4),
    Constant "OVERRIDE_GLTF_BASE_DOUBLE_SIDED" (IVal 5),
    Constant "OVERRIDE_GLTF_METALLIC_FACTOR" (IVal 6),
    Constant "OVERRIDE_GLTF_ROUGHNESS_FACTOR" (IVal 7),
    Constant "OVERRIDE_GLTF_EMISSIVE_FACTOR" (IVal 8),
    ...
    Constant "PARCEL_GLTF_ALPHA_MODE_OPAQUE" (IVal 0),
    Constant "PARCEL_GLTF_ALPHA_MODE_BLEND" (IVal 1),
    Constant "PARCEL_GLTF_ALPHA_MODE_MASK" (IVal 2),
    ...
    Constant "PRIM_TYPE_LEGACY" (IVal 1),
    ...
    Constant "REZ_FLAG_TEMP" (IVal 0x0001),
    Constant "REZ_FLAG_PHYSICAL" (IVal 0x0002),
    Constant "REZ_FLAG_PHANTOM" (IVal 0x0004),
    Constant "REZ_FLAG_DIE_ON_COLLIDE" (IVal 0x0008),
    Constant "REZ_FLAG_DIE_ON_NOENTRY" (IVal 0x0010),
    Constant "REZ_FLAG_NO_COLLIDE_OWNER" (IVal 0x0020),
    Constant "REZ_FLAG_NO_COLLIDE_FAMILY" (IVal 0x0040),
    Constant "REZ_FLAG_BLOCK_GRAB_OBJECT" (IVal 0x0080),
    ...
    Constant "SIT_FLAG_SIT_TARGET" (IVal 0x0001), 
    Constant "SIT_FLAG_ALLOW_UNSIT" (IVal 0x0002), 
    Constant "SIT_FLAG_SCRIPTED_ONLY" (IVal 0x0004), 
    Constant "SIT_FLAG_NO_COLLIDE" (IVal 0x0010), 
    Constant "SIT_FLAG_NO_DAMAGE" (IVal 0x0020), 
    ...
    Constant "TERRAIN_DETAIL_1" (IVal 0),
    Constant "TERRAIN_DETAIL_2" (IVal 1),
    Constant "TERRAIN_DETAIL_3" (IVal 2),
    Constant "TERRAIN_DETAIL_4" (IVal 3),
    Constant "TERRAIN_HEIGHT_RANGE_SW" (IVal 4),
    Constant "TERRAIN_HEIGHT_RANGE_SE" (IVal 5),
    Constant "TERRAIN_HEIGHT_RANGE_NW" (IVal 6),
    Constant "TERRAIN_HEIGHT_RANGE_NE" (IVal 7),
    Constant "TERRAIN_PBR_SCALE_1" (IVal 8),
    Constant "TERRAIN_PBR_SCALE_2" (IVal 9),
    Constant "TERRAIN_PBR_SCALE_3" (IVal 10),
    Constant "TERRAIN_PBR_SCALE_4" (IVal 11),
    Constant "TERRAIN_PBR_ROTATION_1" (IVal 12),
    Constant "TERRAIN_PBR_ROTATION_2" (IVal 13),
    Constant "TERRAIN_PBR_ROTATION_3" (IVal 14),
    Constant "TERRAIN_PBR_ROTATION_4" (IVal 15),
    Constant "TERRAIN_PBR_OFFSET_1" (IVal 16),
    Constant "TERRAIN_PBR_OFFSET_2" (IVal 17),
    Constant "TERRAIN_PBR_OFFSET_3" (IVal 18),
    Constant "TERRAIN_PBR_OFFSET_4" (IVal 19),
    ...
    Constant "VEHICLE_FLAG_BLOCK_INTERFERENCE" (IVal 0x400),
