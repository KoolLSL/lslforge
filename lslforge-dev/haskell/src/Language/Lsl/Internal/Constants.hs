...
allConstants = [
    Constant "KOOL_VERSION_TEST" (SVal "21mar2024 14:00"),
    ...
    Constant "PRIM_ALPHA_MODE_OPAQUE" (IVal 0),
    Constant "PRIM_ALPHA_MODE_BLEND" (IVal 1),
    Constant "PRIM_ALPHA_MODE_MASK" (IVal 2),
    Constant "PRIM_GLTF_BASE_COLOR" (IVal 45),
    Constant "PRIM_GLTF_EMISSIVE" (IVal 46),
    Constant "PRIM_GLTF_METALLIC_ROUGHNESS" (IVal 47),
    Constant "PRIM_GLTF_NORMAL" (IVal 48),
    ...
    Constant "SIT_FLAG_SIT_TARGET" (IVal 0x01),
    Constant "SIT_FLAG_ALLOW_UNSIT" (IVal 0x02),
    Constant "SIT_FLAG_SCRIPTED_ONLY" (IVal 0x04),
    Constant "SIT_FLAG_NO_COLLIDE" (IVal 0x10),
