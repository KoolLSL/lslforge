...
functionSigs = [
    ...
    ("llGetAttachedListFiltered",LLList,[("avatar",LLKey),("options",LLList)],
        "Returns a list of keys of public attachments worn by an avatar (HUD attachment keys are not reported by this function)."),
    ...
    ("llGiveAgentInventory",LLInteger,[("agent",LLKey),("folder",LLString),("inventory",LLList),("options",LLList)],
    ...
    ("llIsLinkGLTFMaterial",LLInteger,[("link",LLInteger),("face",LLInteger)],
    ...
    ("llMapBeacon",LLVoid,[("region_name",LLString),("pos",LLVector),("options",LLList)],
    ...
    ("llSetAgentRot",LLVoid,[("rot",LLRot),("flags",LLInteger)],
    ...
    ("llSetLinkGLTFOverrides",LLVoid,[("link",LLInteger),("face",LLInteger),("params",LLList)],
        "Sets or removes individual overrides applied to a PBR texture on a face."),
    ("llSetGroundTexture",LLVoid,[("changes",LLList)],
    ...
    ("llSetLinkPrimitiveParams",LLVoid,[("linknumber",LLInteger),("rules",LLList)],
        "Set primitive parameters for linknumber based on rules. This function is identical to llSetLinkPrimitiveParams except without the delay."),
    ...
    ("llStopPointAt",LLVoid,[],
        "Stop agent that owns object pointing. REMOVED. Do Not Use"),
    ("llStopSound",LLVoid,[],
        "Stops currently attached sound."),
    ...
    ("llTransferOwnership",LLInteger,[("agent_id",LLKey),("flags",LLInteger),("options",LLList)],
