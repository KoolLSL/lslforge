...
functionSigs = [
    ...
    ("llGetInventoryAcquireTime",LLString,[("item",LLString)],
        "Returns the timestamp that the item was added to the prim's inventory.\n"),
    ...
    ("llGetRegionSunDirection",LLVector,[],
        "Returns a normalized vector to the current sun position at the location of object.\n"),
    ...
    ("llOpenFloater",LLInteger,[("floater_name",LLString),("url",LLString),("params",LLList)],
        "Sends a request to the viewer to open a new floater with the given title. Can only be called from a Linden owned experience.\n"),
