...
functionSigs = [
    ...
    ("llLinksetDataDeleteFound",LLInteger,[("pattern",LLString),("pass",LLString)],
        "The llLinksetDataDeleteFound function finds and attempts to delete all keys in the data store that match pattern. \n"),
    ...
    ("llReplaceEnvironment",LLInteger,[("position",LLVector),("environment",LLString),("track_no",LLInteger),("count",LLInteger)],
        "Replaces the environment in a parcel or a region.\n"),
    ("llReplaceSubString",LLString,[("src",LLString),("pattern",LLString),("replacement_pattern",LLString),("day_length",LLInteger),("day_offset",LLInteger)],
