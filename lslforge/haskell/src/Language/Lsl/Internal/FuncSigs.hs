...
funcSigs = [
    ...
    ("llSetAgentEnvironment",LLVoid,[LLKey,LLFloat,LLList]),
    ...
    ("llSetEnvironment",LLVoid,[LLVector,LLList]),
    ...
    ("llSetInventoryPermMask",LLVoid,[LLString,LLInteger,LLInteger]),
    ...
    ("llSetObjectPermMask",LLVoid,[LLInteger,LLInteger]),
...
funcDescriptions = [
    ...
    ("llAtan2",(["y","x"],"Returns a float that is the arctangent2 of y, x.\n")),
    ...
    ("llGetInventoryNumber",(["type"],"Get the number of items of a given type in the task's inventory.<br/>Valid types: INVENTORY_TEXTURE, INVENTORY_SOUND, INVENTORY_OBJECT, INVENTORY_SCRIPT, INVENTORY_CLOTHING, INVENTORY_BODYPART, INVENTORY_NOTECARD, INVENTORY_LANDMARK, INVENTORY_SETTING, INVENTORY_ALL.\n")),
    ...
    ("llReplaceAgentEnvironment",(["agent_id","transition","environment"],"*** Experience enabled script only ***<br/><br/>Overrides the current region and parcel environment seen by an agent and returns ENV_* error code or '1' upon success. The new environment persists until the agent crosses to a new region or this function is called with the NULL_KEY or empty string in the environment parameter for the particular agent, doing so will strip all environmental settings applied to this agent as part of the experience. This function must be executed as part of an experience.\n")),
    ...
    ("llXorBase64Strings",(["s1","s2"],"**DEPRECATED!** Please use llXorBase64 instead! Incorrectly performs an exclusive or on two Base 64 strings and returns a Base 64 string. s2 repeats if it is shorter than s1. Retained for backwards compatibility.\n")),
